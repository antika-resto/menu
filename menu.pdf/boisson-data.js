...
window.BOISSON = {
  sections: [
    {id:"apero", items:[
      {k:"aperol", n:"Aperol Spritz", p:"9,40", logo:"aperol.png"},
      {k:"aperol0", n:"Aperol Spritz 0%", p:"8,40", logo:"aperol.png"},
    ...
    {id:"bubbles", items:[
      ...
      {sub:"champagne"},
      {k:"lanson", n:"Lanson Black", variants:[["half375","48,00"],["bottle75","85,00"]], logo:"lanson.png"},
      {k:"veuve", n:"Veuve Clicquot", variants:[["bottle75","110,00"]], logo:"veuve.png"},
      {k:"moet", n:"Moët · Ice Impérial", variants:[["bottle75","130,00"]], logo:"moet.png"}
    ]},
    {id:"beer", items:[
      {k:"jupiler25", n:"Jupiler 25 cl · Draft", p:"3,30", logo:"jupiler.png"},
      {k:"jupiler33", n:"Jupiler 33 cl · Draft", p:"3,90", logo:"jupiler.png"},
      {k:"jupiler0", n:"Jupiler 0%", p:"3,50", logo:"jupiler.png"},
      ...
      {k:"leffe_bruin", n:"Leffe Bruin", p:"4,90", logo:"leffe.png"},
    ...
    {id:"soft", items:[
      ...
      {k:"fuze_sparkling", n:"Fuze Tea Sparkling", p:"3,70", logo:"fuze.png"},
      {k:"fuze_peach", n:"Fuze Tea Peach", p:"3,70", logo:"fuze.png"},
      {k:"fuze_mango", n:"Fuze Tea Mango", p:"3,70", logo:"fuze.png"},
      ...
      {k:"mm_appel", n:"Minute Maid Apple", p:"3,70", logo:"minutemaid.png"},
      {k:"mm_appel_kers", n:"Minute Maid Apple-Cherry", p:"3,70", logo:"minutemaid.png"},
      {k:"mm_pompelmoes", n:"Minute Maid Grapefruit", p:"3,70", logo:"minutemaid.png"},
      {k:"mm_multi", n:"Minute Maid Multivitamin", p:"3,70", logo:"minutemaid.png"},
