...
window.BOISSON = {
  sections: [
    {id:"apero", items:[
      {k:"aperol", n:"Aperol Spritz", p:"9,40"},
      {k:"aperol0", n:"Aperol Spritz 0%", p:"8,40"},
      {k:"hugo", n:"Hugo Spritz", p:"9,90"},
      {k:"limoncello_spritz", n:"Limoncello Spritz", p:"9,40"},
      {k:"mandarinetto", n:"Mandarinetto Spritz", p:"9,40"},
      {k:"campari", n:"Campari Orange", p:"8,90"},
      {k:"martini_bianco", n:"Martini Bianco", p:"6,80"},
      {k:"martini_rosso", n:"Martini Rosso", p:"6,80"},
      {k:"martini_bellini", n:"Martini Bellini", p:"8,90"},
      {k:"porto", n:"Porto White / Red", p:"6,80"},
      {k:"ricard", n:"Ricard", p:"7,20"}
    ]},
    {id:"cocktails", items:[
      {sub:"signature"},
      {k:"antika_sunset", n:"Antika Sunset", p:"12,50", d:1},
      {sub:"house"},
      {k:"pornstar", n:"Pornstar Martini", p:"13,00"},
      {k:"mojito", n:"Mojito", p:"12,00"},
      {k:"amaretto_sour", n:"Amaretto Sour", p:"11,00"},
      {sub:"classics"},
      {k:"margarita", n:"Margarita", p:"12,00"},
      {k:"cosmopolitan", n:"Cosmopolitan", p:"11,00"},
      {k:"pina_colada", n:"Piña Colada", p:"11,00"},
      {k:"espresso_martini", n:"Espresso Martini", p:"12,00"},
      {k:"strawberry_daiquiri", n:"Strawberry Daiquiri", p:"12,00"},
      {sub:"mule"},
      {k:"disaronno_mule", n:"Disaronno Mule", p:"12,00", d:1},
      {k:"dominican_mule", n:"Dominican Mule", p:"12,00", d:1},
      {k:"london_mule", n:"London Mule", p:"12,00", d:1},
    ...
    {id:"wine", items:[
      ...
      {k:"wine_quality", variants:[["glass","7,00"],["q","12,00"],["h","22,00"],["bottle","33,00"]]}
    ]},
    {id:"bubbles", items:[
      {k:"prosecco", n:"Prosecco", variants:[["glass","6,50"],["bottle","32,00"]]},
      {k:"pinot_grigio", n:"Pinot Grigio Rosé", variants:[["half375","18,90"],["bottle75","34,50"]]},
      {sub:"champagne"},
      {k:"lanson", n:"Lanson Black", variants:[["half375","48,00"],["bottle75","85,00"]]},
      {k:"veuve", n:"Veuve Clicquot", variants:[["bottle75","110,00"]]},
      {k:"moet", n:"Moët · Ice Impérial", variants:[["bottle75","130,00"]]}
    ]},
    {id:"beer", items:[
      {k:"jupiler25", n:"Jupiler 25 cl · Draft", p:"3,30"},
      {k:"jupiler33", n:"Jupiler 33 cl · Draft", p:"3,90"},
      {k:"jupiler0", n:"Jupiler 0%", p:"3,50"},
      {k:"corona0", n:"Corona 0%", p:"4,70"},
      {k:"leffe_blonde0", n:"Leffe Blonde 0%", p:"4,80"},
      {k:"peja", n:"Birra Peja (Kosova)", p:"4,00"},
      {k:"leffe_blonde", n:"Leffe Blonde · Draft", p:"4,90"},
      {k:"leffe_bruin", n:"Leffe Bruin", p:"4,90"},
      {k:"hoegaarden", n:"Hoegaarden Blanche · Draft", p:"3,90"},
      {k:"karmeliet", n:"Tripel Karmeliet · Draft", p:"5,50"},
    ...
    {id:"soft", items:[
      {k:"coca", n:"Coca-Cola", p:"3,50"},
      {k:"coca_zero", n:"Coca-Cola Zero", p:"3,50"},
      {k:"fanta", n:"Fanta", p:"3,50"},
      {k:"sprite", n:"Sprite", p:"3,50"},
      {k:"fuze_sparkling", n:"Fuze Tea Sparkling", p:"3,70"},
      {k:"fuze_peach", n:"Fuze Tea Peach", p:"3,70"},
      {k:"fuze_mango", n:"Fuze Tea Mango", p:"3,70"},
      {k:"chaud", n:"Chaudfontaine", p:"3,00"},
      {k:"chaud_half", n:"Chaudfontaine 1/2 L", p:"5,50"},
      {k:"chaud_1l", n:"Chaudfontaine 1 L", p:"8,50"},
      {k:"tonic_indian", n:"Royal Bliss Indian Tonic", p:"3,80"},
      {k:"tonic_agrume", n:"Royal Bliss Agrumes Tonic", p:"3,80"},
      {k:"tonic_lemon", n:"Royal Bliss Lemon Tonic", p:"3,80"},
      {k:"tonic_pink", n:"Royal Bliss Pink Tonic", p:"3,80"},
      {k:"mm_appel", n:"Minute Maid Apple", p:"3,70"},
      {k:"mm_appel_kers", n:"Minute Maid Apple-Cherry", p:"3,70"},
      {k:"mm_pompelmoes", n:"Minute Maid Grapefruit", p:"3,70"},
      {k:"mm_multi", n:"Minute Maid Multivitamin", p:"3,70"},
      {k:"almdudler", n:"Almdudler", p:"3,90"},
      {k:"redbull", n:"Red Bull", p:"4,30"},
      {k:"golden_eagle", n:"Golden Eagle", p:"3,50"}
    ]},
    {id:"spirits", items:[
      {sub:"rum"},
      {k:"bacardi", n:"Bacardi Carta Blanca", p:"8,50"},
      {k:"havana", n:"Havana Club 3 Años", p:"8,70"},
      {k:"don_papa_rum", n:"Don Papa", p:"14,50"},
      {sub:"whiskey"},
      {k:"jack", n:"Jack Daniel's", p:"8,80"},
      {k:"jack_honey", n:"Jack Daniel's Honey", p:"8,80"},
      {k:"jack_fire", n:"Jack Daniel's Fire", p:"8,80"},
      {k:"johnnie", n:"Johnnie Walker Red Label", p:"8,50"},
      {k:"chivas12", n:"Chivas Regal 12", p:"9,80"},
      {sub:"vodka"},
      {k:"eristoff", n:"Eristoff / Red", p:"7,90"},
      {k:"absolut", n:"Absolut Vodka", p:"8,50"},
      {k:"ciroc", n:"Cîroc", p:"9,80"},
      {k:"belvedere", n:"Belvedere", p:"9,90"},
      {k:"grey_goose", n:"Grey Goose", p:"9,90"},
      {sub:"gin"},
      {k:"gordons", n:"Gordon's Gin", p:"8,50"},
      {k:"hendricks", n:"Hendrick's", p:"8,90"},
      {k:"gin_mare", n:"Gin Mare", p:"9,20"},
      {k:"copperhead", n:"Copperhead", p:"9,30"},
      {k:"monkey47", n:"Monkey 47", p:"11,60"}
    ]}
  ],

  /* ordre d'ajout des sections partagées (depuis desserts-data.js) */
  sharedTail: ["digestif", "hotdrinks"],
